...
local Window = library:AddWindow("ninja.lol", {
...
ALTab:AddSwitch("Downed Check", function(bool)
    checks.Downed = bool
end)

ALTab:AddSwitch("Picked up check", function(bool)
    checks.Pickup = bool
end)

ALTab:AddSwitch("Visible Only", function(bool)
...
ALTab:AddButton("Fly (X)", function(bool)
    repeat wait() 
